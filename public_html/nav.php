  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <!-- <li class="nav-item">
          <a class="nav-link text-white" href="./nosotros.php">N O S O T R O S</a>
        </li> -->

        <!-- Menú desplegable de NIVELES -->
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle text-white" id="nivelesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            N I V E L E S
          </a>
