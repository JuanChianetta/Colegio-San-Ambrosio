...
<head>
    ...
    <title>Detalle del Colaborador - Viviana Patricia Jaras</title>
...
<body>
    ...
    <section class="colaborador-detalle">
        <div class="colaborador-info">
            <h1>Profesora</h1>
            <h2>Viviana Patricia Jaras</h2>
            <p>Profesora de Educación Secundaria en Matemática</p>
        </div>
        <div class="colaborador-foto">
            <img src="../imagenes/Jaras, Viviana Patricia.jpeg" alt="Foto de Viviana Patricia Jaras">
            <div class="foto-overlay"></div>
        </div>
    </section>
    <section class="quote-banner">
        <p>"La matemática es el lenguaje universal que nos ayuda a entender el mundo."</p>
    </section>
    <section class="trayectoria-section">
        ...
        <ul class="trayectoria-list">
            ...
            <li class="in-view-list">
                <strong>Profesorado de Educación Secundaria en Matemática</strong>
            </li>
        </ul>
    </section>
    <script>
