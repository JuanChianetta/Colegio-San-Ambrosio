...
<head>
    ...
    <title>Detalle del Colaborador - María Milagros Memoli</title>
...
<body>
    ...
    <section class="colaborador-detalle">
        <div class="colaborador-info">
            <h1>Profesora</h1>
            <h2>María Milagros Memoli</h2>
            <p>Profesora de Matemática y Astronomía</p>
        </div>
        <div class="colaborador-foto">
            <img src="../imagenes/Memoli María Milagros.jpeg" alt="Foto de María Milagros Memoli">
            <div class="foto-overlay"></div>
        </div>
    </section>
    <section class="quote-banner">
        <p>"La enseñanza de la matemática abre puertas a nuevos universos."</p>
    </section>
    <section class="trayectoria-section">
        ...
        <ul class="trayectoria-list">
            <li class="in-view-list">
                <strong>Profesora de Matemática y Astronomía</strong>
            </li>
            <li class="in-view-list">
                <strong>Licenciada en Enseñanza de la Matemática</strong>
            </li>
        </ul>
    </section>
    <script>
