...
<head>
    ...
    <title>Detalle del Colaborador - Marisa Andrea Cobo</title>
...
<body>
    ...
    <section class="colaborador-detalle">
        <div class="colaborador-info">
            <h1>Profesora</h1>
            <h2>Marisa Andrea Cobo</h2>
            <p>Contador Público</p>
        </div>
        <div class="colaborador-foto">
            <img src="../imagenes/Cobo marisa Andrea.jpeg" alt="Foto de Marisa Andrea Cobo">
            <div class="foto-overlay"></div>
        </div>
    </section>
    <section class="quote-banner">
        <p>"La educación es la base del desarrollo profesional y personal."</p>
    </section>
    <section class="trayectoria-section">
        ...
        <ul class="trayectoria-list">
            ...
            <li class="in-view-list">
                <strong>Postgrado en Formación Gerencial</strong>
            </li>
            <li class="in-view-list">
                <strong>P.N.L. Nivel Master</strong>
            </li>
        </ul>
    </section>
    <script>
